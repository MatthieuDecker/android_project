...
public class Addresse {
	...
	public Addresse(int _NoCivique, String _NomRue, String _Ville,
			String _Province, String _CodePostal) {
	...
	public String toStringAddress() {
		return new String(_NoCivique + " " + _NomRue + "\n" + _Ville + "\n"
				+ _Province + " " + _CodePostal);
	}
